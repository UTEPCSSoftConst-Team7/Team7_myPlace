  ...
  var Workpage = Barba.BaseView.extend({
    ...
    onLeaveCompleted: function () {
      documentBody.classList.contains("night-mode") &&
        ...
        documentBody.classList.contains("work-page-js") ||
        documentBody.classList.remove("work-page");
    },
  });
  Workpage.init();
